            ...
            <div className="w-1/3">
                ...
                <div className="font-semibold">
                    <div className="text-secondary flex flex-col gap-2">
                        ...
                        <div className="p-4 pr-18 rounded-xl border-1 border-secondary bg-[var(--color-whiteGray)]">
                    ...
                    <button onClick={() => navigate("/wallet#transfer")} className="text-center w-full my-4 p-2 rounded-xl bg-[var(--color-secondary)] text-white font-normal cursor-pointer border-secondary border-1 hover:bg-[var(--color-secondary-hover)] hover:text-secondary">
